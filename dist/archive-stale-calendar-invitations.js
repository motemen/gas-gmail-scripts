...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/archive-stale-calendar-invitations.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/archive-stale-calendar-invitations.ts":
/*!***************************************************!*\
  !*** ./src/archive-stale-calendar-invitations.ts ***!
  \***************************************************/
/*! no static exports found */
...
global.main = function main() {
    ...
    var now = new Date();
    var invitationThreads = GmailApp.search("invite.ics in:inbox");
    for (var _i = 0, invitationThreads_1 = invitationThreads; _i < invitationThreads_1.length; _i++) {
        var thread = invitationThreads_1[_i];
